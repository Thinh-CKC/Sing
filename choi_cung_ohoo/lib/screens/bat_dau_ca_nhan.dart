...
class BatDauCaNhanScreen extends StatefulWidget {
  const BatDauCaNhanScreen({Key? key}) : super(key: key);

  @override
  State<BatDauCaNhanScreen> createState() => _BatDauCaNhanState();
}

class _BatDauCaNhanState extends State<BatDauCaNhanScreen> {
  @override
